...
.branch-item:hover{ border-color: rgba(29,78,216,.25); }
.branch-muted{ font-size:12px; color: rgba(15,23,42,.65); margin-top:8px; }
</style>

<main class="page">
  <div class="card">
    <h2 class="card-title" style="margin-bottom:6px;">Yeni Kullanıcı Oluştur</h2>
    <div class="card-sub">
    ...
    <form method="post" autocomplete="off">
      ...
      <div class="form one" id="jsBranchesWrap" style="display:none;">
        <div class="field">
