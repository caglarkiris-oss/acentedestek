<?php
// /public_html/platform/mutabakat/ajax-send-period.php
...
ini_set('error_log', __DIR__.'/_mutabakat_ajax_send_ticket_error.log');
...
/*
  ✅ KURAL:
  - Main: child tali için OPEN yapabilir (SUPERADMIN hariç child kontrol)
...
try {
  if ($isMain) {
    if ($role !== 'SUPERADMIN') {
      ...
      // SUPERADMIN: talinin parent'ını main olarak yaz
  ...
  error_log("ajax-send-period.php err: ".$e->getMessage());
  http_response_code(500);
